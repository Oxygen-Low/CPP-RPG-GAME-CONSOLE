...
int main() {
    ...
    //Define variable for skillpoints available to spend
    int skillpoints{5};
    cout << "How many skill points do you want to put into defence?: ";
    //Define variable for skillpoints that the player requests
    int requestedskillpoints;
    //Allow player to input skillpoints
    ...
    int endurance{0};
    int vitality{10};
    //Checking if player requests to assign more skillpoints than they have
    if(requestedskillpoints > skillpoints) {
        ...
        //If player has enough skillpoints to assign, set defence to the requested skillpoints
        defence = requestedskillpoints + defence;
        cout << "New defence skill is now: " << defence << "." << endl;
        //Lower skillpoints by the amount of skillpoints the player requests to assign
